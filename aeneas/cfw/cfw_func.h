...
#define CFW_SUCCESS 0
#define CFW_FAILURE 1
#define CFW_FALSE 0
#define CFW_TRUE 1

// Festival-specific
// Festival defines SUCCESS = TRUE = 1 and FAILURE = False = 0
#define CFW_FESTIVAL_SUCCESS 1
#define CFW_FESTIVAL_FAILURE 0
#define CFW_HEAP_SIZE 1000000
#define CFW_LOAD_INIT_FILES 1
...
int _synthesize_multiple(
    ...
    const int backwards,
    int *sample_rate_ret, // int because the Festival lib returns it as such
