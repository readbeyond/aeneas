...
class ExecuteTaskCLI(AbstractCLIProgram):
    ...
    DEMOS = {
        ...
        u"--example-ctw-espeak" : {
            ...
            u"options": u"-r=\"tts=custom|tts_path=aeneas/extra/ctw_espeak.py\"",
            u"show": False
        },
        u"--example-ctw-speect" : {
            ...
            u"options": u"-r=\"tts=custom|tts_path=aeneas/extra/ctw_speect/ctw_speect.py\"",
            u"show": False
        },
        u"--example-eaf" : {
            ...
            for key in self.DEMOS:
                if self.has_option(key):
                    ...
                    if key == u"--example-cewsubprocess":
                        ...
                        self.rconf[RuntimeConfiguration.TTS_PATH] = "aeneas/extra/ctw_espeak.py"
