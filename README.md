...
on other Linux distributions (Gentoo, Ubuntu, Slackware),
...
It is strongly recommended to run the **aeneas** CLI tools
on a shell with UTF-8 encoding.
Also note that all strings and files read/written by **aeneas**
